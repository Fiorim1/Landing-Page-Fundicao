...
import Whatsappp from "../assets/whatsorange.png"
    ...
    return (
        <footer className='footer'>
            <div className="phones">
                <div className="tel">
                    <img src={Tel} alt="" className='telphone' />
                    <p>(48)99999-9999</p>
                </div>
                <div className="phoneFooter">
                    <img src={Whatsappp} alt="" className='whatss' />
                    <p>(48)99999-9999</p>
                </div>
            </div>
            <div className="location">
                <img src={Location} alt="" className='locationimg' />
                <p>Rua das Palmeiras, nº 1234, Bairro Jardim Novo Horizonte, CEP 04567-890 – São Paulo/SP</p>
            </div>
